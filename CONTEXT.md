...
- Images convert to Markdown images. An enclosing anchor destination takes precedence over `src`, while ordinary text links retain normal Markdown-link output.
